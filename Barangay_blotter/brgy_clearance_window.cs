...
{
    public partial class brgy_clearance_window : Form
    {
        string filename = "";
        public brgy_clearance_window()
        {
            InitializeComponent();
        ...
        private void process_docx()
        {
            ...
            document = application.Documents.Add(Template: @"C:\Users\Fzkn4\Documents\Barangay Clearance.docx");
            ...
            try
            {
                ...
                filename = "BRGYClearance-" + lname.Text + fname.Text + mname.Text;
